...
@Component
public class HelpMessageCommandExecutor implements MessageCommandExecutor {

    public static final String REPLY_KEY = "reply.help";

    private final DialogsStateCache dialogsStateCache;
    private final LocaleMessageRepo messageRepo;

    public HelpMessageCommandExecutor(DialogsStateCache dialogsStateCache, LocaleMessageRepo messageRepo) {
